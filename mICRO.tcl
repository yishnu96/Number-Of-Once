# 
# Project automation script for mICRO 
# 
# Created for ISE version 14.3
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source mICRO.tcl), then you can
...
proc set_project_props {} {
   ...
   project set device "xc5vlx20t"
   project set package "ff323"
   project set speed "-2"
...
proc add_source_files {} {
   ...
   project set top "Behavioral" "onse"
...
proc set_process_props {} {
   ...
   project set "Target UCF File Name" "F:/Semester Project/8085/mICRO/onse.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Work Directory" "F:/Semester Project/8085/mICRO/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "onse" -process "Generate IBIS Model"
